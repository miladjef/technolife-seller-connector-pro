...
class TLSCP_Installer {
    ...
    public static function default_options() {
        return array(
            ...
            'price_unit' => 'rial',
            'price_basis' => 'wc',
            'reference_markup_percent' => '0',
            'enforce_leasing_range' => 'yes',
            'enforce_bnpl_range' => 'yes',
            'competitive_repricing' => 'no',
            'competitive_undercut_type' => 'amount',
            'competitive_undercut_value' => '0',
            'competitive_min_margin_percent' => '0',
            'idempotent_sync' => 'yes',
            'request_throttle_ms' => '0',
            'request_max_retries' => '2',
            'realtime_sync' => 'no',
            'use_action_scheduler' => 'yes',
            'cron_scan_buybox' => 'no',
            'notify_email' => '',
            'notify_buybox_loss' => 'no',
